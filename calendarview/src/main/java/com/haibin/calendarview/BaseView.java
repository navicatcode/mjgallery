...
public abstract class BaseView extends View implements View.OnClickListener, View.OnLongClickListener {
    ...
    private void initPaint(Context context) {
        ...
        mCurDayTextPaint.setColor(Color.WHITE);//TODO 当天的日期颜色
...
//        this.mCurMonthTextPaint.setColor(mDelegate.getCurrentMonthTextColor());
        this.mCurMonthTextPaint.setColor(CalendarViewDelegate.color);
...
//        this.mSelectedPaint.setColor(mDelegate.getSelectedThemeColor());//todo gai
    }
