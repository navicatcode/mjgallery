...
//        mCurDayTextPaint.setColor(Color.RED);//todo
    ...
    final void updateStyle() {
        ...
        Log.i("日历背景色执行流程 6", "SimpleWeekView onDrawText mCurrentMonthTextColor=" + mDelegate.getYearViewDayTextColor());
...
//        this.mCurDayTextPaint.setColor(mDelegate.getYearViewCurDayTextColor());//todo
