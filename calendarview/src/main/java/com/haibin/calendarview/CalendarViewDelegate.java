...
public class CalendarViewDelegate {
    ...
    private Drawable mSelectedThemeColor;
    /**
     * 自定义的日历路径
     */
    ...
    public CalendarViewDelegate(Context context, @Nullable AttributeSet attrs) {
        ...
        array.getDrawable(R.styleable.CalendarView_current_day_text_color);
        mCurDayLunarTextColor = array.getColor(R.styleable.CalendarView_current_day_lunar_text_color, Color.BLUE);
        //todo gai
//        mSelectedThemeColor = array.getColor(R.styleable.CalendarView_selected_theme_color, 0x50CFCFCF);
        mSelectedThemeColor = array.getDrawable(R.styleable.CalendarView_selected_theme_color);//选中改为背景图片
        mCurrentMonthTextColor = array.getColor(R.styleable.CalendarView_current_month_text_color, Color.BLACK);//当天之前为灰色，之后为黑色
        mYearViewMonthTextColor = array.getColor(R.styleable.CalendarView_year_view_month_text_color, Color.GRAY);
        mYearViewCurDayTextColor = array.getColor(R.styleable.CalendarView_year_view_current_day_text_color, 0xFF111111);
...
//        }
    ...
    public void setCurrentMonthTextColor(int mCurrentMonthTextColor) {
        color = mCurrentMonthTextColor;
        this.mCurrentMonthTextColor = mCurrentMonthTextColor;
    }

    Drawable getSelectedThemeColor() {
    ...
    void setTextColor(/*Drawable curDayTextColor,*/int currentMonthTextColor, int otherMonthTextColor, int curMonthLunarTextColor, int otherMonthLunarTextColor) {
    ...
    void setSelectColor(Drawable selectedColor, int selectedTextColor, int selectedLunarTextColor) {
    ...
    void setThemeColor(Drawable selectedThemeColor, int schemeColor) {
