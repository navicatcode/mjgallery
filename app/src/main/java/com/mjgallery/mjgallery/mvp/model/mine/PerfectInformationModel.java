 ...
 */
@ActivityScope
public class PerfectInformationModel extends BaseModel implements PerfectInformationContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public PerfectInformationModel(IRepositoryManager repositoryManager) {
