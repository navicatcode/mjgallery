 ...
 */
@ActivityScope
public class SelectApplicableModel extends BaseModel implements SelectApplicableContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public SelectApplicableModel(IRepositoryManager repositoryManager) {
