 ...
 */
@ActivityScope
public class HomePictureDetailsPresenter extends BasePresenter<HomePictureDetailsContract.Model, HomePictureDetailsContract.View> {
    @Inject
    ...
    @Inject
    public HomePictureDetailsPresenter(HomePictureDetailsContract.Model model, HomePictureDetailsContract.View rootView) {
        super(model, rootView);
    }


    public void externalStorage(boolean isShare) {
    ...
    public void getAddCommentRecommend(Map<String, Object> map) {
        mModel.getAddCommentRecommend(map)
                ...
                .compose(RxLifecycleUtils.bindToLifecycle(mRootView))//使用 Rxlifecycle,使 Disposable 和 Activity 一起销毁
                .subscribe(new ErrorHandleSubscriber<BaseResponse<HomeDetailsCommentsBean.DataBean>>(mErrorHandler) {
                    @Override
                    public void onNext(BaseResponse<HomeDetailsCommentsBean.DataBean> listBaseResponse) {
                        if (listBaseResponse != null) {
                            EventBus.getDefault().post(new RemoveTokenEvent(listBaseResponse.getCode()));
