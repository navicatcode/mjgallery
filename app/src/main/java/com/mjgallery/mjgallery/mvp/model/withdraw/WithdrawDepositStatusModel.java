 ...
 */
@ActivityScope
public class WithdrawDepositStatusModel extends BaseModel implements WithdrawDepositStatusContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public WithdrawDepositStatusModel(IRepositoryManager repositoryManager) {
    ...
    @Override
    public Observable<BaseResponse> getMeWithdrawUpMsg(Map<String, Object> map) {
        //使用rxcache缓存,上拉刷新则不读取缓存,加载更多读取缓存
        return Observable.just (mRepositoryManager
                .obtainRetrofitService(CommonService.class)
                .getMeWithdrawUpMsg(map))
