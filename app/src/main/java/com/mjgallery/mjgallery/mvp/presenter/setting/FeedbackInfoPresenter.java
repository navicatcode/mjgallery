 ...
 */
@ActivityScope
public class FeedbackInfoPresenter extends BasePresenter<FeedbackInfoContract.Model, FeedbackInfoContract.View> {
    @Inject
    ...
    @Inject
    public FeedbackInfoPresenter(FeedbackInfoContract.Model model, FeedbackInfoContract.View rootView) {
    ...
    public void requestMeFeedback(Map<String, Object> map, File file) {
                ...
                .subscribe(new ErrorHandleSubscriber<BaseResponse>(mErrorHandler) {
                    ...
                    public void onNext(BaseResponse listBaseResponse) {
                        if (listBaseResponse != null) {
                            ...
                            mRootView.onMeFeedback(listBaseResponse);
                        }
                    }
                });
