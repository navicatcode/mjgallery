 ...
 */
@ActivityScope
public class PetElvesDetailsModel extends BaseModel implements PetElvesDetailsContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public PetElvesDetailsModel(IRepositoryManager repositoryManager) {
