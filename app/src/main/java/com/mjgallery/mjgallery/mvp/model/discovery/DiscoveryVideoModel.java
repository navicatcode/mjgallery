 ...
 */
@FragmentScope
public class DiscoveryVideoModel extends BaseModel implements DiscoveryVideoContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public DiscoveryVideoModel(IRepositoryManager repositoryManager) {
