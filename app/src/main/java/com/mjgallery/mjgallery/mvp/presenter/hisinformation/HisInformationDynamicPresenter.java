 ...
 */
@FragmentScope
public class HisInformationDynamicPresenter extends BasePresenter<HisInformationDynamicContract.Model, HisInformationDynamicContract.View> {
    @Inject
    ...
    @Inject
    public HisInformationDynamicPresenter(HisInformationDynamicContract.Model model, HisInformationDynamicContract.View rootView) {
    ...
    public void requestDataHerInformationList(Map<String,Object> map) {
        mRootView.showLoading();
        mModel.getHerInformationList(map)
                ...
                .subscribe(new ErrorHandleSubscriber<BaseResponse<List<MyShowBean>>>(mErrorHandler) {
                    ...
                    public void onNext(BaseResponse<List<MyShowBean>> listBaseResponse) {
                        if (listBaseResponse != null) {
                            ...
                            mRootView.onHerInformationList(listBaseResponse.getResult());
                        }
                    }
                });
    }
