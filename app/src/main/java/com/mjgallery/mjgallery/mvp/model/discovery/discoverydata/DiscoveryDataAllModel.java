 ...
 */
@FragmentScope
public class DiscoveryDataAllModel extends BaseModel implements DiscoveryDataAllContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public DiscoveryDataAllModel(IRepositoryManager repositoryManager) {
