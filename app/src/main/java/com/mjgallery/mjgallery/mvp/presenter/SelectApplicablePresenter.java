 ...
 */
@ActivityScope
public class SelectApplicablePresenter extends BasePresenter<SelectApplicableContract.Model, SelectApplicableContract.View> {
    @Inject
    ...
    @Inject
    public SelectApplicablePresenter(SelectApplicableContract.Model model, SelectApplicableContract.View rootView) {
