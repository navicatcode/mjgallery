 ...
 */
@FragmentScope
public class DiscoveryCircleModel extends BaseModel implements DiscoveryCircleContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public DiscoveryCircleModel(IRepositoryManager repositoryManager) {
