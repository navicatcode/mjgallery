...
import com.mjgallery.mjgallery.di.component.DaggerDiscoveryCircleComponent;
...
import com.mjgallery.mjgallery.mvp.presenter.discovery.DiscoveryCirclePresenter;
...
public class DiscoveryCircleFragment extends MJBaseFragment<DiscoveryCirclePresenter> implements
        DiscoveryCircleContract.View, DiscoveryViewAdapter.IDiscoveryClickListener {
    ...
    public void setupFragmentComponent(@NonNull AppComponent appComponent) {
        DaggerDiscoveryCircleComponent //如找不到该类,请编译一下项目
                .builder()
    ...
    public View initView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_discovery_circle, container, false);
    }
    ...
    public void initData(@Nullable Bundle savedInstanceState) {
        ...
        discoveryViewAdapter = new DiscoveryViewAdapter(R.layout.discovery_view_item, discoveryViewBeans, this, getActualWidth());
