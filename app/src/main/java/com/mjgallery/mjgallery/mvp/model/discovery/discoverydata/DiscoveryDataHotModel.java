 ...
 */
@ActivityScope
public class DiscoveryDataHotModel extends BaseModel implements DiscoveryDataHotContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public DiscoveryDataHotModel(IRepositoryManager repositoryManager) {
