 ...
 */
@FragmentScope
public class WithdrawPayPresenter extends BasePresenter<WithdrawPayContract.Model, WithdrawPayContract.View> {
    @Inject
    ...
    @Inject
    public WithdrawPayPresenter(WithdrawPayContract.Model model, WithdrawPayContract.View rootView) {
    ...
    public void requestWithdrawMsg(Map<String, Object> map, File file) {
        ...
        mModel.getWithdrawMsg(map,body)
