 ...
 */
@FragmentScope
public class MyAttentionOneModel extends BaseModel implements MyAttentionOneContract.Model {
    @Inject
    Gson mGson;
    @Inject
    ...
    @Inject
    public MyAttentionOneModel(IRepositoryManager repositoryManager) {
    ...
    @Override
    public Observable<BaseResponse<List<MyAttentionItemBean>>> getMyConcern(Map<String, Object> map) {
