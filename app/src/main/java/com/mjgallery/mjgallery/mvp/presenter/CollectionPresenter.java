...
public class CollectionPresenter extends BasePresenter<CollectionContract.Model, CollectionContract.View> {
                ...
                .subscribe(new ErrorHandleSubscriber<BaseResponse<List<CollectionBean>>>(mErrorHandler) {
                    ...
                    public void onNext(BaseResponse<List<CollectionBean>> listBaseResponse) {
                        if (listBaseResponse != null) {
                            ...
                            mRootView.onMyCollection(listBaseResponse.getResult(), listBaseResponse.getCount());
                        }
                    }
                });
    ...
    public void requestDelete(Map<String, Object> map) {
        mModel.getCollectionDelete(map)
                .subscribeOn(Schedulers.io())
                .retryWhen(new RetryWithDelay(3, 15))//遇到错误时重试,第一个参数为重试几次,第二个参数为重试的间隔
                .subscribeOn(AndroidSchedulers.mainThread())
                .observeOn(AndroidSchedulers.mainThread())
                ...
                .subscribe(new ErrorHandleSubscriber<BaseResponse>(mErrorHandler) {
                    ...
                    public void onNext(BaseResponse listBaseResponse) {
                        if (listBaseResponse != null) {
                            EventBus.getDefault().post(new RemoveTokenEvent(listBaseResponse.getCode()));
                            mRootView.getCollectionDelete(listBaseResponse);
