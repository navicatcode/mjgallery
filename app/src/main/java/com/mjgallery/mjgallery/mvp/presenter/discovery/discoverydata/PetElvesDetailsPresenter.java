 ...
 */
@ActivityScope
public class PetElvesDetailsPresenter extends BasePresenter<PetElvesDetailsContract.Model, PetElvesDetailsContract.View> {
    @Inject
    ...
    @Inject
    public PetElvesDetailsPresenter(PetElvesDetailsContract.Model model, PetElvesDetailsContract.View rootView) {
