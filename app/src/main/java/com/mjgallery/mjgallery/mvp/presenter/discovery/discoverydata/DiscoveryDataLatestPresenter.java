 ...
 */
@FragmentScope
public class DiscoveryDataLatestPresenter extends BasePresenter<DiscoveryDataLatestContract.Model, DiscoveryDataLatestContract.View> {
    @Inject
    ...
    @Inject
    public DiscoveryDataLatestPresenter(DiscoveryDataLatestContract.Model model, DiscoveryDataLatestContract.View rootView) {
