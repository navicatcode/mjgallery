...
import com.mjgallery.mjgallery.di.component.DaggerVIPWithdrawComponent;
...
import com.mjgallery.mjgallery.mvp.presenter.mine.VIPWithdrawPresenter;
 ...
 * ================================================
 */
public class VIPWithdrawFragment extends MJBaseFragment<VIPWithdrawPresenter> implements VIPWithdrawContract.View {
    ...
    int timeType=1;
    public static VIPWithdrawFragment newInstance() {
        VIPWithdrawFragment fragment = new VIPWithdrawFragment();
        return fragment;
    }

    @Override
    public void setupFragmentComponent(@NonNull AppComponent appComponent) {
        DaggerVIPWithdrawComponent //如找不到该类,请编译一下项目
                .builder()
    ...
    public View initView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_vipwithdraw, container, false);
    }
    ...
    public void initData(@Nullable Bundle savedInstanceState) {
        ...
        myVIPWithdrawListAdapter = new MyVIPWithdrawListAdapter(R.layout.adapter_vip_withdraw_item,
                myVIPWithdrawItemBeanList, false);
