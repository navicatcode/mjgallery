...
public class SearchUserPresenter extends BasePresenter<SearchUserContract.Model, SearchUserContract.View> {
    ...
    public void getSearchUser(Map<String, Object> map) {
        mRootView.showLoading();
        mModel.getSearchUser(map)
                ...
                .subscribe(new ErrorHandleSubscriber<BaseResponse<List<SearchUserBean>>>(mErrorHandler) {
                    @Override
                    public void onNext(BaseResponse<List<SearchUserBean>> listBaseResponse) {
                        if (listBaseResponse != null) {
                            mRootView.onSearchUser(listBaseResponse.getResult());
                        }
                    }
                });
    }
