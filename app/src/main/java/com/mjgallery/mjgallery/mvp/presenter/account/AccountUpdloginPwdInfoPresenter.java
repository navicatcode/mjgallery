 ...
 */
@ActivityScope
public class AccountUpdloginPwdInfoPresenter extends BasePresenter<AccountUpdloginPwdInfoContract.Model, AccountUpdloginPwdInfoContract.View> {
    @Inject
    ...
    @Inject
    public AccountUpdloginPwdInfoPresenter(AccountUpdloginPwdInfoContract.Model model, AccountUpdloginPwdInfoContract.View rootView) {
    ...
    public void requestChangeLoginPassword(Map<String, Object> map) {
        mRootView.showLoading();
        mModel.getChangeLoginPassword(map)
                ...
                .subscribe(new ErrorHandleSubscriber<BaseResponse>(mErrorHandler) {
                    ...
                    public void onNext(BaseResponse listBaseResponse) {
                        ...
                        mRootView.onChangeLoginPassword(listBaseResponse);
                    }
                });
    }
