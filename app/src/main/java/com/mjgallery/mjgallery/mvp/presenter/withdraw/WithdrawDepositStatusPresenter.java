 ...
 */
@ActivityScope
public class WithdrawDepositStatusPresenter extends BasePresenter<WithdrawDepositStatusContract.Model, WithdrawDepositStatusContract.View> {
    @Inject
    ...
    @Inject
    public WithdrawDepositStatusPresenter(WithdrawDepositStatusContract.Model model, WithdrawDepositStatusContract.View rootView) {
        ...
        mModel.getMeWithdrawUpMsg(map)
                ...
                .subscribe(new ErrorHandleSubscriber<BaseResponse>(mErrorHandler) {
                    ...
                    public void onNext(BaseResponse listBaseResponse) {
                            ...
                            mRootView.onMeWithdrawUpMsg(listBaseResponse);
