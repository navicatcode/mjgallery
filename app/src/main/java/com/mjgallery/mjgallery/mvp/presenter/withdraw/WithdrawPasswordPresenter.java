 ...
 */
@FragmentScope
public class WithdrawPasswordPresenter extends BasePresenter<WithdrawPasswordContract.Model, WithdrawPasswordContract.View> {
    @Inject
    ...
    @Inject
    public WithdrawPasswordPresenter(WithdrawPasswordContract.Model model, WithdrawPasswordContract.View rootView) {
