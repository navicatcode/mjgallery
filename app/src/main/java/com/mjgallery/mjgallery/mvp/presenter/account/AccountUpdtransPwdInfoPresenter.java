 ...
 */
@ActivityScope
public class AccountUpdtransPwdInfoPresenter extends BasePresenter<AccountUpdtransPwdInfoContract.Model, AccountUpdtransPwdInfoContract.View> {
    @Inject
    ...
    @Inject
    public AccountUpdtransPwdInfoPresenter(AccountUpdtransPwdInfoContract.Model model, AccountUpdtransPwdInfoContract.View rootView) {
    ...
    public void requestChangePayPassword(Map<String, Object> map) {

        mModel.getChangePayPassword(map)
                .subscribeOn(Schedulers.io())
                .retryWhen(new RetryWithDelay(1, 2))//遇到错误时重试,第一个参数为重试几次,第二个参数为重试的间隔
                .subscribeOn(AndroidSchedulers.mainThread())
                .observeOn(AndroidSchedulers.mainThread())
                ...
                .subscribe(new ErrorHandleSubscriber<BaseResponse>(mErrorHandler) {
                    ...
                    public void onNext(BaseResponse listBaseResponse) {
                        ...
                        mRootView.onChangePayPassword(listBaseResponse);
                    }
                });
    }
}
