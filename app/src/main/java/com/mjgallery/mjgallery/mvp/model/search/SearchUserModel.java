...
public class SearchUserModel extends BaseModel implements SearchUserContract.Model {
    ...
    @Override
    public Observable<BaseResponse<List<SearchUserBean>>> getSearchUser(Map<String, Object> map) {
        //使用rxcache缓存,上拉刷新则不读取缓存,加载更多读取缓存
        return Observable.just(mRepositoryManager
                .obtainRetrofitService(CommonService.class)
                .getSearchUser(map))
                .flatMap(new Function<Observable<BaseResponse<List<SearchUserBean>>>, ObservableSource<BaseResponse<List<SearchUserBean>>>>() {
                    @Override
                    public ObservableSource<BaseResponse<List<SearchUserBean>>> apply(@NonNull Observable<BaseResponse<List<SearchUserBean>>> listObservable) throws Exception {
