 ...
 */
@FragmentScope
public class SearchDataPresenter extends BasePresenter<SearchDataContract.Model, SearchDataContract.View> {
    @Inject
    ...
    @Inject
    public SearchDataPresenter(SearchDataContract.Model model, SearchDataContract.View rootView) {
        super(model, rootView);
    }

    public void getSearchData(Map<String, Object> map) {
        mRootView.showLoading();
        mModel.getSearchData(map)
                ...
                .subscribe(new ErrorHandleSubscriber<BaseResponse<List<DiscoveryDataBean>>>(mErrorHandler) {
                    ...
                    public void onNext(BaseResponse<List<DiscoveryDataBean>> listBaseResponse) {
                        if (listBaseResponse != null) {
                            mRootView.onSearchData(listBaseResponse.getResult());
                        }
                    }
                });
    }
