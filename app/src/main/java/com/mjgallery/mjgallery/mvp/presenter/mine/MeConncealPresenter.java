 ...
 */
@ActivityScope
public class MeConncealPresenter extends BasePresenter<MeConncealContract.Model, MeConncealContract.View> {
    @Inject
    ...
    @Inject
    public MeConncealPresenter(MeConncealContract.Model model, MeConncealContract.View rootView) {
    ...
    public void requestMePrivacy(Map<String, Object> map) {
        mRootView.showLoading();
        mModel.getMePrivacy(map)
                ...
                .subscribe(new ErrorHandleSubscriber<BaseResponse>(mErrorHandler) {
                    ...
                    public void onNext(BaseResponse listBaseResponse) {
                        ...
                        mRootView.onMePrivacy(listBaseResponse);
                    }
                });
    }
}
