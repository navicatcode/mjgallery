...
public class LotteryRecordPresenter extends BasePresenter<LotteryRecordContract.Model, LotteryRecordContract.View> {
    ...
    @Inject
    public LotteryRecordPresenter(LotteryRecordContract.Model model, LotteryRecordContract.View rootView) {
        super(model, rootView);
    }


    public void requestLotteryRecordData(Map<String, Object> map) {
                ...
                .subscribe(new ErrorHandleSubscriber<BaseResponse<List<LotteryRecordBean>>>(mErrorHandler) {
                    ...
                    public void onNext(BaseResponse<List<LotteryRecordBean>> listBaseResponse) {
                        if (listBaseResponse.getCode() == 0) {
                            mRootView.getRecord(listBaseResponse.getResult());
                        }
                    }
                });
    }
