...
import com.mjgallery.mjgallery.mvp.model.mine.myvip.MyVIPModel;
 ...
 */
@Module
public abstract class MyVIPModule {

    @Binds
    abstract MyVIPContract.Model bindMyVIPModel(MyVIPModel model);
}