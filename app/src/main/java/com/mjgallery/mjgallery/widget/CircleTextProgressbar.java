...
public class CircleTextProgressbar extends AppCompatTextView {
    ...
    public CircleTextProgressbar(@NonNull Context context) {
        this(context, null);
    }

    public CircleTextProgressbar(@NonNull Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CircleTextProgressbar(@NonNull Context context, AttributeSet attrs, int defStyleAttr) {
