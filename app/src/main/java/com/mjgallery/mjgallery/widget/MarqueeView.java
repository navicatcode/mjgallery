...
public class MarqueeView extends AppCompatTextView implements Runnable {
     ...
     * @param strings
     */
    public void setContent(@Nullable List<String> strings) {
     ...
     * @parambt_control00
     */
    public void setContent(@NonNull String content2) {
...
//    }
    ...
    private float getContentWidth(@Nullable String black) {
        if (black == null || black == "") {
            return 0;
        }
     ...
     * @param textSize
     */
    public void setTextSize(float textSize, Typeface typeface) {
