...
public class CircleMovementMethod extends BaseMovementMethod {
    ...
    public CircleMovementMethod(){
        this.textViewBgColor = ArmsUtils.getColor(BaseApplication.getInstance(),DEFAULT_COLOR_ID);
        this.clickableSpanBgClor =  ArmsUtils.getColor(BaseApplication.getInstance(),DEFAULT_CLICKABLEA_COLOR_ID);
    }
