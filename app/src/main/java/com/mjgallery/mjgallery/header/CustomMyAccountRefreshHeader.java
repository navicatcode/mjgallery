...
public class CustomMyAccountRefreshHeader extends LinearLayout implements RefreshHeader {
    ...
    public CustomMyAccountRefreshHeader(Context context) {
        this(context, null, 0);
    }

    public CustomMyAccountRefreshHeader(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomMyAccountRefreshHeader(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        View view = View.inflate(context, R.layout.widget_custom_my_account_refresh_header, this);
    ...
    public void onStateChanged(RefreshLayout refreshLayout, RefreshState oldState, RefreshState newState) {
        switch (newState) {
            case PullDownToRefresh: //下拉刷新开始。正在下拉还没松手时调用
                ...
                mImage.setImageResource(R.drawable.head_refresh_1);
                break;
