 ...
 * @describe IOS底部选择对话框
 */
public class BottomIosSelectDialog implements View.OnClickListener {
     ...
     * @return this
     */
    public BottomIosSelectDialog showDialog(Activity activity) {
        if (bottomDialog == null && !activity.isFinishing()) {
            bottomDialog = new Dialog(activity, R.style.edit_AlertDialog_style);
            View contentView = LayoutInflater.from(activity).inflate(R.layout.dialog_content_circle, null);
...
//            contentView.setLayoutParams(params);
    ...
    private void initView(View contentView) {
        //相机
        TextView camera = contentView.findViewById(R.id.camera);
        camera.setOnClickListener(this);
        //相册
        TextView album = contentView.findViewById(R.id.album);
...
//        bottomDialog = null;
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.camera:
                anInterface.selectedCamera();
                cancle();
                break;
            case R.id.album:
                anInterface.selectedAlbum();
                cancle();
                break;
            case R.id.cancle:
                cancle();
