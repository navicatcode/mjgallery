...
public class GetDeviceId {
    ...
    //保存文件的路径
    private static final String CACHE_IMAGE_DIR = "crown/cache/devices";
    //保存的文件 采用隐藏文件的形式进行保存
    private static final String DEVICES_FILE_NAME = ".CROWN_DEVICES";
    ...
    public static void getDeviceId() {
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    //获取保存在sd中的 设备唯一标识符
                    String readDeviceID = GetDeviceId.readDeviceID(BaseApplication.getInstance());
...
//        return info.getMacAddress();
     ...
     * @param context
     */
    public static void saveDeviceID(String str, @NonNull Context context) {
        File file = getDevicesDir(context);
        try {
     ...
     */
    @NonNull
    public static String getMD5(@NonNull String message, boolean upperCase) {
        String md5str = "";
        try {
     ...
     */
    @Nullable
    private static File getDevicesDir(@NonNull Context context) {
        File mCropFile = null;
