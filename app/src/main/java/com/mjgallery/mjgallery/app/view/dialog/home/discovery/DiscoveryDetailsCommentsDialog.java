package com.mjgallery.mjgallery.app.view.dialog.home.discovery;
 ...
 * 首页详情评论列表
 */
public class DiscoveryDetailsCommentsDialog extends BaseDialog implements View.OnClickListener {
    ...
    public DiscoveryDetailsCommentsDialog(Activity activity, IDiscoveryDetailsComments mIDiscoveryDetailsComments) {
        super(activity);
        ...
        switch (view.getId()) {
            case R.id.llCopy:
                if (TextUtils.isEmpty(copyText)) {
                    ArmsUtils.makeText(getContext(),ArmsUtils.getString(BaseApplication.getInstance(),R.string.copy_error));
                     return;
                }
