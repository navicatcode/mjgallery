package com.mjgallery.mjgallery.app.view;
 ...
 */
public class NavTabRound extends BaseTabItem {
    ...
    public NavTabRound(Context context) {
        this(context, null);
    }

    public NavTabRound(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public NavTabRound(Context context, AttributeSet attrs, int defStyleAttr) {
