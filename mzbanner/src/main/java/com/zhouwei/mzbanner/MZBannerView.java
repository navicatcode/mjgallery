...
public class MZBannerView<T> extends RelativeLayout {
    ...
    StickinessIndicatorView mStickinessIndicatorView;
    ...
    private int mDelayedTime = 6000;// Banner 切换时间间隔
    ...
    private boolean mIsCanLoop = false;// 是否轮播图片
...
//    private int[] mIndicatorRes = new int[]{R.drawable.indicator_normal, R.drawable.indicator_selected};
    ...
    private void init() {
        ...
        mStickinessIndicatorView = (StickinessIndicatorView) view.findViewById(R.id.mStickinessIndicatorView);
...
//    }
    ...
    public void setIndicatorVisible(boolean visible) {
        if (visible) {
            mStickinessIndicatorView.setVisibility(VISIBLE);
        } else {
            mStickinessIndicatorView.setVisibility(GONE);
        }
    }
...
//
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageScrolled(int position, float positionOffset, int positionOffsetPixels) {
                ...
                if (mStickinessIndicatorView != null) {
                    mStickinessIndicatorView.setOnPageScrolled(realPosition, positionOffset, positionOffsetPixels);
                }
            }
            ...
            public void onPageSelected(int position) {
                ...
                int realSelectPosition = mCurrentItem % mDatas.size();
        ...
        if (mStickinessIndicatorView != null) {
            mStickinessIndicatorView.setCount(mDatas.size());
            mStickinessIndicatorView.setCount(mDatas.size());
            mStickinessIndicatorView.setViewPager(mViewPager, mDatas.size());
            mStickinessIndicatorView.setStartX();
            mStickinessIndicatorView.invalidate();
        }
    ...
    public void setIndicatorAlign(IndicatorAlign indicatorAlign) {
        ...
        LayoutParams layoutParams = (LayoutParams) mStickinessIndicatorView.getLayoutParams();
        ...
        mStickinessIndicatorView.setLayoutParams(layoutParams);

    }


    public StickinessIndicatorView getIndicatorContainer() {
        return mStickinessIndicatorView;
    }
